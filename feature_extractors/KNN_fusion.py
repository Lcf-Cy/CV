...
class KNNFusionFeatures(Features):
    ...
    def add_sample_to_mem_bank(self, sample, class_name=None):
        ...
        # else:
        fusion_patch = torch.cat([fused_output_rgb,fused_output_xyz], dim=1)
        print(fusion_patch.shape)
# 命令 python3 main.py --method_name GraphKNN --memory_bank multiple --rgb_backbone_name vit_base_patch8_224_dino --xyz_backbone_name Point_MAE --save_feature
