...
from feature_extractors import multiple_features, KNN_fusion
...
class M3DM():
    def __init__(self, args):
        ...
        elif args.method_name == 'MambaFusion':
            self.methods = {
                "MambaFusion": multiple_features.MambaFusionFeatures(args),
            }
        elif args.method_name == 'GraphKNN':
            self.methods = {
                "GraphKNN": multiple_features.KNNFusionFeatures(args),
            }
