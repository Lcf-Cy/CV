...
if __name__ == '__main__':
    ...
    parser.add_argument('--method_name', default='DINO+Point_MAE+Fusion', type=str, 
                        choices=['DINO', 'Point_MAE', 'Fusion', 'DINO+Point_MAE', 'MambaFusion','DINO+Point_MAE+Fusion','GraphKNN', 'DINO+Point_MAE+add'],
    ...
    parser.add_argument('--rgb_backbone_name', default='vit_base_patch8_224_dino', type=str, 
                        choices=['vit_base_patch8_224_dino', 'vit_base_patch8_224', 'SwinTransformer','vit_base_patch8_224_in21k', 'vit_small_patch8_224_dino'],
    ...
    parser.add_argument('--use_uff', default=False, action='store_true',
                        help='Use UFF module.')
    parser.add_argument('--save_feature_path', default='/root/autodl-tmp/patch_lib', type=str,
                        help='Save feature for training fusion block.')
    ...
    parser.add_argument('--dataset_path', default='/root/autodl-tmp/mvtec3d', type=str, 
